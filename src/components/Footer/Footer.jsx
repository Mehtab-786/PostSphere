        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-slate-600 text-sm max-w-md leading-relaxed">
              Building exceptional digital experiences with modern technology and innovative design solutions.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.024-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.72-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.024 0 1.518.769 1.518 1.688 0 1.029-.653 2.567-.992 3.992-.285 1.193.6 2.165 1.775 2.165 2.128 0 3.768-2.245 3.768-5.487 0-2.861-2.063-4.869-5.008-4.869-3.41 0-5.409 2.562-5.409 5.199 0 1.033.394 2.143.889 2.143.183 0 .371-.063.51-.17.157-.12.21-.336.1-.563-.105-.21-.394-1.193-.394-1.193-.105-.12-.394-.563-.394-1.193 0-1.193.967-2.063 2.168-2.063 1.193 0 2.063.967 2.063 2.168 0 1.193-.967 2.063-2.168 2.063z"/>
                </svg>
              </a>
            </div>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-slate-500">
              &copy; 2025 Made by Mehtab
            </p>
            
            <div className="flex items-center space-x-6">
              <a href="#" className="text-sm text-slate-500 hover:text-slate-700 transition-colors duration-200">
                Status
              </a>
              <a href="#" className="text-sm text-slate-500 hover:text-slate-700 transition-colors duration-200">
                Changelog
